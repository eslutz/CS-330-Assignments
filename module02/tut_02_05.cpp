...
namespace
{
const char* const WINDOW_TITLE = "Tutorial 2.5"; // Macro for window title
...
const char *vertexShaderSource = "#version 440 core\n"
    ...
    "void main()\n"
    "{\n"
    "   gl_Position = vec4(aPos, aPos.y, aPos.z, 1.0);\n" // Removed aPos.x to introduce error for testing
    "}\0";
...
void UCreateMesh(GLMesh &mesh)
{
    // Specifies Normalized Device Coordinates for triangle
    GLfloat verts[]=
    {
